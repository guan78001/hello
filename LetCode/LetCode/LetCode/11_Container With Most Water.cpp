...
//    int leftX, rightX;
//    int leftY, rightY;
//    Item(int lx = 0, int rx = 0, int ly = 0, int ry = 0) : leftX(lx), leftY(ly), rightX(rx), rightY(ry) {}
//    int area() {
//      return (rightX - leftX) * std::min(leftY, rightY);
//    }
//    operator int() {
//      return area();
//    }
...
//    //DP
//    int len = height.size();
//    vector<Item> P(len * len);
//#define P(i,j) P[(i)*len+(j)]
//    //init
//    for (int i = 0; i < len - 1; i++) {
//      P(i, i) = Item(i, i, height[i], height[i]);
//      P(i, i + 1) = Item(i, i + 1, height[i], height[i + 1]);
//    }
//    P(len - 1, len - 1) = Item(len - 1, len - 1, height[len - 1], height[len - 1]);
//
//    for (int k = 2; k < len; k++) {
//      for (int i = 0; i < len - k; i++) {
//        int j = i + k;
//        P(i, j) = Item(i, j, height[i], height[j]);
//        for (int t = 1; t < k; t++) {
//          if (P(i, i + t) > P(i, j)) {
//            P(i, j) = P(i, i + t);
//          }

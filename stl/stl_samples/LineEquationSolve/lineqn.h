...
/********************************************************************\
* ludcmp - Given a matrix a[n][n], this routine replaces it by the   *
*          LU decomposition of a rowwise permutation of itself.      *
*          a and n are input.  a is output.  indx[n] is an output    *
*          vector that records the row permutation effected by the   *
*          partial pivoting.  d is output as +/- 1 depending on      *
...
/********************************************************************\
* lubksb - Solves the set of n linear equations A*X=B.  Here,        *
*          a[n][n] is input, not as the matrix A but rather as its   *
*          LU decomposition, determined by the routine ludcmp().     *
*          indx[n] is input as the permutation vector returned by    *
*          ludcmp().  b[n] is input as the right-hand side vector B, *
*          and returns with the solution vector X.                   *
*          a, n, and indx are not modified by this routine and can   *
*          be left in place for successive calls with different      *
*          right-hand sides b.  This routine takes into account the  *
